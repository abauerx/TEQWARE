...
base='http://www.teqware.cu.cc'
ADDON=xbmcaddon.Addon(id='plugin.video.teqware')
...
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/abauerx/TEQWAREs/master/wizard.txt').replace('\n','').replace('\r','')
